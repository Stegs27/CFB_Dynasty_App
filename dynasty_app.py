        ...
        if not _coach_record_row.empty:
            ...
            if '-' in _cr_record:
                try:
                    ...
                    pass
            _natties = int(_safe_num(pd.Series([_coach_record_row.get(_smart(coach_records, ['NationalTitles']), np.nan)])).iloc[0] or 0) if _smart(coach_records, ['NationalTitles']) else _natties
