...
def live_reveal_nfl_draft(generated_df, speed_mode="Broadcast"):
    ...
    for idx, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        if round_num == 1:
            ...
            on_clock_html = '<span style="display:inline-block;font-size:0.82rem;color:#fef3c7;font-weight:800;padding:6px 10px;border-radius:999px;background:rgba(245,158,11,0.14);border:1px solid rgba(245,158,11,0.24);white-space:nowrap;">On the Clock</span>'
                            ...
                            <div style="display:flex; align-items:center; min-width:0;">
                                ...
                                <div style="min-width:0;">
                                    ...
                                    <div style="font-size:0.9rem; opacity:0.9; color:#d1d5db;">
                                        ...
                                        Round {int(r.get("DraftRoundCanon", 0))} • Pick {int(r.get("GeneratedOverallPick", 0))} •
    ...
    with nfl_tabs[4]:
        ...
        if nfl_roster.empty:
            ...
            with left:
                ...
                show_cols = [c for c in ["Player", "Pos", "PosBucket", "OVR", "Age", "SPD", "ACC", "AWR"] if
                             c in roster_team.columns]
            ...
            if drafted_here.empty:
                ...
                featured = drafted_here.head(6).copy()
